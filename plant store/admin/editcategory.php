...
$result=mysqli_query($connection,"select id_category,name,description from categories where id_category='$id_category'")or die ("Zapytanie select niepoprawne");

list($id_category,$category_name,$description)=mysqli_fetch_array($result);
...
mysqli_query($connection,"UPDATE categories SET name='$category_name',description='$description' WHERE id_category='$id_category'")or die("Zapytanie Update niepoprawne");
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          ...
          </svg>Panel Administratora  <small> - Edytuj Kategorie</small></h1>
        </div>
...
<tr>
           ...
           <td> <label>Nazwa kategori</label></td>
           <td> <input type="text" id="category_name" name="category_name" value="<?=$category_name?>" required maxlength="49"></br></td>
</tr>
<tr>


<td> <label>Opis</label></td>
<td> <textarea type="text" id="description" name="description" rows="5" cols="33" style="resize: none;" maxlength="799"><?=$description?></textarea></td>
          
          </tr>
          <tr>
          
          <td> <button type="submit" name="btn_save" id="btn_save">Aktualizuj kategorie</button></td>
</tr>
</tbody>
</table>
            </form>
