...
mysqli_query($connection,"DELETE FROM orders WHERE id_order='$id_order'")or die("Blad zapytania delete");
}
//
?>
<html lang="pl">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          ...
          </svg>Panel Administratora  <small> - Zamówienia</small></h1>
        </div>
...
<div class="row">
 ...
 <div class="list-group">
    ...
    <a href="category.php" class="list-group-item list-group-item-action"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
        ...
        <div class="card">
          <div class="card-body">        
            ...
            <thead>
                ...
                <tbody >
                  <?php 
                  $sql='SELECT id_order,id_user,phone_number,order_date,status FROM orders';
                  $result = mysqli_query($connection, $sql);

                  while(list($id_order,$id_user,$phone_number,$order_date,$status)=mysqli_fetch_array($result)): ?>
                  <tr>
                    <td><?=$id_order?></td>
                    <td><?=$id_user?></td>
                    <td><?=$phone_number?></td>
                    ...
                    <td><a class="btn btn-success" href='orderdetails.php?id_order=<?=$id_order?>'>Szczegóły Zamówienia</a> <a class="btn btn-danger" href='orders.php?id_order=<?=$id_order?>&action=delete'>Usuń</a>  </td>
                  </tr>
                  <?php endwhile; 
