...
mysqli_query($connection,"delete from users where id_user='$id_user'")or die("Blad zapytania delete");
}
//
?>
<html lang="pl">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          ...
          </svg>Panel Administratora  <small> - Użytkownicy</small></h1>
        </div>
        ...
        <div class="card">
          <div class="card-body">        
            ...
            <thead>
                ...
                <tbody >
                <?php 
                  $sql='SELECT id_user,nickname,role,status,email,phone_number,id_address FROM users';
                  $result = mysqli_query($connection, $sql);

                  while(list($id_user,$nickname,$role,$status,$email,$phone_number,$id_address)=mysqli_fetch_array($result)): 
                ?>
                  <tr>  
                    <td><?=$id_user?></td>
                    <td><?=$nickname?></td>
                    ...
                    <td><?=$phone_number?></td>
                    <td><?=$id_address?></td>
                    <td> <a class="btn btn-danger" href='users.php?id_user=<?=$id_user?>&action=delete'>Usuń</a>  </td>
                  </tr>
                <?php
                  endwhile;
