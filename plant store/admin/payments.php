...
mysqli_query($connection,"delete from payments where id_payment='$id_payment'")or die("Blad zapytania delete");
}
//
//Creating new item
if(isset($_POST['btn_save']))
{
    ...
    mysqli_query($connection,"insert into payments (method_name) values ('$method_name')") or die ("blad zapytania insertinto");
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          ...
          </svg>Panel Administratora  <small> - Metody Płatności</small></h1>
        </div>
 ...
 <div class="list-group">
  ...
  <div class="card">
    <div class="card-header color bg-success ">     
      <a type="button" data-toggle="modal" data-target="#DodajPłatność" href="orders.html" style="color:black;" ><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="black" class="bi bi-plus-square" viewBox="0 0 16 16">
        <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
      </svg>Dodaj Metodę Płatności</a>
    </div>
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="card">
          <div class="card-body">        
            ...
            <thead>
                  <tr>       
                    <th scope="col">Nazwa metody płatności</th>
                    <th scope="col">Edycja</th>                  
                  </tr>   
                </thead>
                <tbody >
                  <?php 
                  $sql='SELECT id_payment,method_name FROM payments';
                  $result = mysqli_query($connection, $sql);

                  while(list($id_payment,$method_name)=mysqli_fetch_array($result)):?>
                  <tr>
                    <td><?=$method_name?></td>
                    <td><a  type="button" class="btn btn-success" href='editpayment.php?id_payment=<?=$id_payment?>'>Edytuj</a> <a class="btn btn-danger" href='payments.php?id_payment=<?=$id_payment?>&action=delete'>Usuń</a>  </td>
                  </tr>
                  <?php
                  endwhile;
    ...
    <script>
     ...
     <!-- Modal -->
     <div class="modal fade" id="DodajPłatność" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            
            <h5 class="modal-title" id="exampleModalLabel">Dodaj metodę płatności</h5>
          ...
          <div class="modal-body">
            ...
            <label>Nazwa metody platnosci</label>
            <input type="text" id="method_name" name="method_name" required style="float:right" maxlength="49"></br>   
          </div>
