...
mysqli_query($connection,"insert into products (name, description,price,img, insolation, watering_frequency,difficulty_of_growing,allergens,id_category) values ('$product_name','$description','$price','$image','$insolation','$watering_frequency','$difficulty_of_growing','$allergens','$id_category')") or die ("blad zapytania insertinto");
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          ...
          </svg>Panel Administratora  <small> - Produkty</small></h1>
        </div>
 ...
 <div class="list-group">
  ...
  <div class="card">
    <div class="card-header color bg-success ">     
      <a type="button" data-toggle="modal" data-target="#DodajProdukt" href="orders.html" style="color:black;" ><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="black" class="bi bi-plus-square" viewBox="0 0 16 16">
        ...
        <div class="card">
          <div class="card-body">        
            ...
            <thead>
                ...
                <tbody >
                <?php 
                $sql='SELECT id_product,name,description,price,img,id_category FROM products';
                $result = mysqli_query($connection, $sql);

                while(list($id_product,$product_name,$description,$price,$img,$id_category)=mysqli_fetch_array($result)): ?>
                  <tr>
                    <td><img src="data:image/jpeg;base64,<?=base64_encode($img )?>" height="200" width="200"/></td>
                    <td><?=$product_name?></td>                   
                    <td><?=$description?></td>
                    <td><?=number_format($price,2)?> zł.</td>
                    <td><?=$id_category?></td> 
                    <td><a type="button" class="btn btn-success" href='editproduct.php?id_product=<?=$id_product?>'>Edytuj</a> <a class="btn btn-danger" href='products.php?id_product=<?=$id_product?>&action=delete'>Usuń </a>  </td>
                  </tr>
                <?php
                endwhile;
    ...
    <!-- Modal -->
    <div class="modal fade" id="DodajProdukt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="text" id="product_name" name="product_name" required style="float:right" maxlength="49"></br>

            <label>Opis produktu:</label>
            <input type="text" id="description" name="description" style="float:right" maxlength="1499"></br>

            <label>Cena:</label>
            <input type="number" step="0.01" min="0.01" id="price" name="price" required style="float:right"></br>

            <label>Nasłonecznienie:</label>
            <input type="number" id="insolation" min="0" max="6" name="insolation" style="float:right"></br>

            <label>Czestotliwosc podlewania:</label>
            <input type="number" min="0" max="6" id="watering_frequency" name="watering_frequency" style="float:right"></br>

            <label>Trudność uprawy:</label>
            <input type="number" min="0" max="6" id="difficulty_of_growing" name="difficulty_of_growing" style="float:right"></br>

            <label>Alergeny:</label>
            <input type="text" id="allergens" name="allergens" style="float:right" maxlength="49"></br>
            <label>Kategoria:</label>
            <select name="category" style="float:right; width:193.69px">
            ...
            <label>Zdjęcie:</label>
            <input type="file" id="img" name="img" style="float:right"></br>
          </div>
