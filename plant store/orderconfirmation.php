...
<head>
    ...
    <title>PlantStore - Potwierdzenie zamówienia</title>
...
<body>
 <?php include("header.php"); ?>
    ...
    <h2>Dziękujemy za złożenie zamówienia !</h2>
        ...
        <h3>Zamówienie zostanie wysłane w przeciągu 48 godzin od złożenia zamówienia.</h3>
        <h4 style="padding-top: 30px">Aby sprawdzić status zamówienia <a href="account/index.php" style="color:#e23838">kliknij tutaj</a></h4>
        </div>
    </div>
